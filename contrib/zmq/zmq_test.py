...
"""
    ...
    UnemployCoin should be started with the command line arguments:
        unemploycoind -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND UNEMP issuance at " + str(pos))
				print("After UNEMP: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND UNEMP something at " + str(pos))
			start += pos+8
			print(astr)
