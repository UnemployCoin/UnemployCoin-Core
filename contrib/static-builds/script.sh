...
rm -rf ~/unemploycoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../unemploycoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../unemploycoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/unemploycoin/temp
cd ~/unemploycoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/unemploycoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/unemploycoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
