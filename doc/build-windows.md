...
Below are some notes on how to build UnemployCoin Core for Windows.
...
way. This will install to `c:\workspace\unemploycoin`, for example:

    make install DESTDIR=/mnt/c/workspace/unemploycoin
