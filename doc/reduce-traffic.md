...
By default, unemploycoin-core allows up to 125 connections to different peers, 12 of
...
limits are tiny. Keep in mind that unemploycoin's trustless model works best if you are
