UnemployCoin Core version *2.1.0* is now available!!
==============

  <https://github.com/RavenProject/UnemployCoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/RavenProject/UnemployCoin/commits/release_2.1.0>
