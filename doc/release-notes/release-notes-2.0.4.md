UnemployCoin Core version *2.0.4.0* is now available!!
==============

  <https://github.com/RavenProject/UnemployCoin/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/RavenProject/UnemployCoin/commits/release_2.0.4>
