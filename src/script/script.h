...
#ifndef UNEMPLOYCOIN_SCRIPT_SCRIPT_H
#define UNEMPLOYCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    bool GetOp2(const_iterator& pc, opcodetype& opcodeRet, std::vector<unsigned char>* pvchRet) const
    {
        ...
        // If we see an op unemp asset, we consider all data after it has data, and not op codes
    ...
    /**
     * Pre-version-0.6, UnemployCoin always counted CHECKMULTISIGs
...
#endif // UNEMPLOYCOIN_SCRIPT_SCRIPT_H
