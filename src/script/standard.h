...
#ifndef UNEMPLOYCOIN_SCRIPT_STANDARD_H
#define UNEMPLOYCOIN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_UNEMPLOYCOIN_ASSET script that carries data
    /** UNEMP END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a unemploycoin address
 */
...
/**
 * Generate a UnemployCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // UNEMPLOYCOIN_SCRIPT_STANDARD_H
