...
#ifndef UNEMPLOYCOIN_VALIDATION_H
#define UNEMPLOYCOIN_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for unemploycoin, with 1 minutes block intervals?
...
#endif // UNEMPLOYCOIN_VALIDATION_H
