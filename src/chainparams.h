...
#ifndef UNEMPLOYCOIN_CHAINPARAMS_H
#define UNEMPLOYCOIN_CHAINPARAMS_H
 ...
 * UnemployCoin system. There are three: the main network on which people trade goods
...
#endif // UNEMPLOYCOIN_CHAINPARAMS_H
