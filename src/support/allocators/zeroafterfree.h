...
#ifndef UNEMPLOYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define UNEMPLOYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // UNEMPLOYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
