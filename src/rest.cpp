...
#include "version.h"
#include "rpc/server.h"          // for RPCIsInWarmup, JSONRPCRequest, RPCSerializationFlags
          // for HTTPStatusCode, HTTP_OK, etc.
         // optional, if you see any GetTime or system macros
