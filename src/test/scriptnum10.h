...
#ifndef UNEMPLOYCOIN_TEST_SCRIPTNUM10_H
#define UNEMPLOYCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from UnemployCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // UNEMPLOYCOIN_TEST_BIGNUM_H
