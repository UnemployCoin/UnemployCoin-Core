...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler unemp tx
        CScript unempTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut unempOut(1*COIN, unempTransfer);
        ...
        mutTxTest1.vout.emplace_back(unempOut);
        ...
        mutTxTest2.vout.emplace_back(unempOut);
        ...
        mutTxTest3.vout.emplace_back(unempOut);
        ...
        mutTxTest4.vout.emplace_back(unempOut);
        ...
        mutTxTest5.vout.emplace_back(unempOut);
        ...
        mutTxTest6.vout.emplace_back(unempOut);
        ...
        mutTxTest7.vout.emplace_back(unempOut);
        ...
        mutTxTest8.vout.emplace_back(unempOut);
