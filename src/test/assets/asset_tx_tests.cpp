...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_not_valid_test)
    {
        ...
        // This should fail because 900 UNEMPLOYCOIN doesn't have a destination
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets_test)
    {
        ...
        CAssetTransfer asset2("UNEMPLOYCOINTESTTEST", 1000);
        CScript scriptPubKey2 = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        asset2.ConstructTransaction(scriptPubKey2);

        CAssetTransfer asset3("UNEMPLOYCOINTESTTESTTEST", 1000);
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            CAssetTransfer outAsset2("UNEMPLOYCOINTESTTEST", 100);
            ...
            // Add the third asset
            CAssetTransfer outAsset3("UNEMPLOYCOINTESTTESTTEST", 100);
        ...
        // The inputs are spending 3000 Assets (1000 of each UNEMPLOYCOIN, RAVENTEST, UNEMPLOYCOINTESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each UNEMPLOYCOIN, RAVENTEST, UNEMPLOYCOINTESTTEST)
