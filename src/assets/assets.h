...
#ifndef UNEMPLOYCOIN_ASSET_PROTOCOL_H
#define UNEMPLOYCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_UNEMPLOYCOIN_ASSET UNEMPQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_UNEMPLOYCOIN_ASSET UNEMPO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_UNEMPLOYCOIN_ASSET UNEMPR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_UNEMPLOYCOIN_ASSET UNEMPT
...
#endif //UNEMPLOYCOIN_ASSET_PROTOCOL_H
