...
#ifndef UNEMPLOYCOIN_QT_UNEMPLOYCOINGUI_H
#define UNEMPLOYCOIN_QT_UNEMPLOYCOINGUI_H
...
/**
  UnemployCoin GUI main class. This class represents the main window of the UnemployCoin UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a unemploycoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // UNEMPLOYCOIN_QT_UNEMPLOYCOINGUI_H
