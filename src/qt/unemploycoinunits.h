...
#ifndef UNEMPLOYCOIN_QT_UNEMPLOYCOINUNITS_H
#define UNEMPLOYCOIN_QT_UNEMPLOYCOINUNITS_H
...
/** UnemployCoin unit definitions. Encapsulates parsing and formatting
...
#endif // UNEMPLOYCOIN_QT_UNEMPLOYCOINUNITS_H
