...
#ifndef UNEMPLOYCOIN_QT_GUIUTIL_H
#define UNEMPLOYCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the UnemployCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "unemploycoin:" URI into recipient object, return true on successful parsing
...
#endif // UNEMPLOYCOIN_QT_GUIUTIL_H
