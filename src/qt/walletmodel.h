...
#ifndef UNEMPLOYCOIN_QT_WALLETMODEL_H
#define UNEMPLOYCOIN_QT_WALLETMODEL_H
...
/** Interface to UnemployCoin wallet from Qt view code. */
...
#endif // UNEMPLOYCOIN_QT_WALLETMODEL_H
