...
QList<RavenUnits::Unit> RavenUnits::availableUnits()
{
    ...
    unitlist.append(UNEMP);
    unitlist.append(mUNEMP);
    unitlist.append(uUNEMP);
    return unitlist;
}
...
QString RavenUnits::name(int unit)
{
    switch(unit)
    {
    case UNEMP: return QString("UNEMP");
    case mUNEMP: return QString("mUNEMP");
    case uUNEMP: return QString::fromUtf8("μUNEMP");
...
QString RavenUnits::description(int unit)
{
    switch(unit)
    {
    case UNEMP: return QString("Ravens");
    case mUNEMP: return QString("Milli-Ravens (1 / 1" THIN_SP_UTF8 "000)");
    case uUNEMP: return QString("Micro-Ravens (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 RavenUnits::factor(int unit)
{
    switch(unit)
    {
    case UNEMP:  return 100000000;
    case mUNEMP: return 100000;
    case uUNEMP: return 100;
...
int RavenUnits::decimals(int unit)
{
    ...
    {
    case UNEMP: return 8;
    case mUNEMP: return 5;
    case uUNEMP: return 2;
    default: return 0;
    }
}
...
{
    return format(UNEMP, amount / factorAsset(MAX_ASSET_UNITS - unit), plussign, separators, unit) + QString(" ") + customName;
}
