 ...
 */
#ifndef UNEMPLOYCOIN_UTIL_H
#define UNEMPLOYCOIN_UTIL_H
...
extern const char *const UNEMPLOYCOIN_CONF_FILENAME;
extern const char *const UNEMPLOYCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("unemploycoin-%s", name);
