...
class TestRavenCli(RavenTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `unemploycoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `unemploycoin-cli -getinfo` and the RPCs data is retrieved from.")
