...
# TestNode: A peer we use to send messages to unemploycoind, and store responses.
...
class CompactBlocksTest(RavenTestFramework):
    ...
    # This test actually causes unemploycoind to (reasonably!) disconnect us, so do this last.
    ...
    # unemploycoind's choice of nonce.
    ...
    # Test that unemploycoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for unemploycoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # unemploycoind will not send blocktxn responses for blocks whose height is
